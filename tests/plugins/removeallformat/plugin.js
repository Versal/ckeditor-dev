...
bender.test(
{
	'test removeallformat fire editor#selectionChange': function() {
	...
	'test removeallformat remove bold, italicize, underline': function() {
		bender.editorBot.create( {
			name: 'test_editor1',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove li inside ul': function() {
		bender.editorBot.create( {
			name: 'test_editor4',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove ol': function() {
		bender.editorBot.create( {
			name: 'test_editor5',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove li inside ol': function() {
		bender.editorBot.create( {
			name: 'test_editor6',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove indentation': function() {
		bender.editorBot.create( {
			name: 'test_editor7',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove blockquote': function() {
		bender.editorBot.create( {
			name: 'test_editor8',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove right-to-left text direction': function() {
		bender.editorBot.create( {
			name: 'test_editor9',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove link - inside link': function() {
		bender.editorBot.create( {
			name: 'test_editor10',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove link - outside link': function() {
		bender.editorBot.create( {
			name: 'test_editor11',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove sans-serif font': function() {
		bender.editorBot.create( {
			name: 'test_editor13',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove serif font': function() {
		bender.editorBot.create( {
			name: 'test_editor14',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove style - special container': function() {
		bender.editorBot.create( {
			name: 'test_editor15',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove style - small': function() {
		bender.editorBot.create( {
			name: 'test_editor16',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove style - normal': function() {
		bender.editorBot.create( {
			name: 'test_editor17',
			config: { allowedContent: true }
		}, function( bot ) {
	...
	'test removeallformat remove style - large': function() {
		bender.editorBot.create( {
			name: 'test_editor18',
			config: { allowedContent: true }
		}, function( bot ) {
